...
import { RelocateTroopsModal } from 'app/(game)/(village-slug)/(village)/(...building-field-id)/components/building-tabs/rally-point/components/stationed-troops/relocate-troops-modal';
import { ReturnReinforcementsModal } from 'app/(game)/(village-slug)/(village)/(...building-field-id)/components/building-tabs/rally-point/components/stationed-troops/return-reinforcements-modal';
import {
  Section,
  SectionContent,
...
export const RallyPointReinforcementsTab = () => {
  ...
  return (
    <Section>
      <SectionContent>
        <InformationPopover ariaLabel={t('Reinforcements')}>
          <Text>
            {t(
