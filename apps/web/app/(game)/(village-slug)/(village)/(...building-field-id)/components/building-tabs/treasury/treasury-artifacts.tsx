...
import { useArtifactsAroundCurrentVillage } from 'app/(game)/(village-slug)/(village)/(...building-field-id)/components/building-tabs/treasury/hooks/use-artifacts-around-current-village';
import {
  OverflowContainer,
  Section,
  SectionContent,
