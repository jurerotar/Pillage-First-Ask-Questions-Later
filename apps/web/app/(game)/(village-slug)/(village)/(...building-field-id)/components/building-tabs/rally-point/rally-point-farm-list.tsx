...
import { CreateFarmListModal } from 'app/(game)/(village-slug)/(village)/(...building-field-id)/components/building-tabs/rally-point/components/farm-list/create-farm-list-modal';
import { EditFarmListModal } from 'app/(game)/(village-slug)/(village)/(...building-field-id)/components/building-tabs/rally-point/components/farm-list/edit-farm-list-modal';
import { useFarmLists } from 'app/(game)/(village-slug)/(village)/(...building-field-id)/components/building-tabs/rally-point/hooks/use-farm-lists';
import {
  Section,
  SectionContent,
