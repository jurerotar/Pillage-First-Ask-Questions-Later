...
import { BuildingStatsUpgradeBenefits } from 'app/(game)/(village-slug)/(village)/(...building-field-id)/components/building-tabs/building-stats/components/building-stats-upgrade-benefits';
import { BuildingStatsUpgradeCost } from 'app/(game)/(village-slug)/(village)/(...building-field-id)/components/building-tabs/building-stats/components/building-stats-upgrade-cost';
import { BuildingStatsUpgradeDuration } from 'app/(game)/(village-slug)/(village)/(...building-field-id)/components/building-tabs/building-stats/components/building-stats-upgrade-duration';
import {
  Section,
  SectionContent,
