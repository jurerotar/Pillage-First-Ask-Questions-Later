...
export const isUnitImprovementEvent = (event: GameEvent): event is GameEvent<'unitImprovement'> => {
  return event.type === 'unitImprovement';
};

export const isUnitResearchEvent = (event: GameEvent): event is GameEvent<'unitResearch'> => {
