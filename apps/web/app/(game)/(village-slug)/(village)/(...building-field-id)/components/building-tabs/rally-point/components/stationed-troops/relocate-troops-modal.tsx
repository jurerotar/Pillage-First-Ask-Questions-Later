...
import { useTroopSelectionForm } from 'app/(game)/(village-slug)/(village)/(...building-field-id)/components/building-tabs/rally-point/components/stationed-troops/hooks/use-troop-selection-form';
