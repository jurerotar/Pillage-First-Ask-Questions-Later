...
type CapitalizeWords<S extends string> = S extends `${infer First}_${infer Rest}`
...
export type UpperCaseToCamelCase<S extends string> = S extends `${infer First}_${infer Rest}`
