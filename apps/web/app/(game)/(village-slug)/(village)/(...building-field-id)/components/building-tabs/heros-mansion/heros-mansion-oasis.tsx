...
import { useOccupiableOasisInRange } from 'app/(game)/(village-slug)/(village)/(...building-field-id)/components/building-tabs/heros-mansion/hooks/use-occupiable-oasis-in-range';
import {
  OverflowContainer,
  Section,
  SectionContent,
