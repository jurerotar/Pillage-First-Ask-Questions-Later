...
const TroopListContent = () => {
  ...
  return (
    <aside className="fixed right-0 bottom-safe-offset-26 lg:bottom-14 flex lg:flex-col gap-1 bg-background/80 p-1 shadow-xs border-border rounded-r-none rounded-xs transition-[bottom]">
      <div
