...
import { useDragImage } from 'app/(game)/(village-slug)/(village)/(...building-field-id)/components/building-tabs/main-building/components/hooks/use-drag-image';
import { useRearrangeBuildingFields } from 'app/(game)/(village-slug)/(village)/(...building-field-id)/components/building-tabs/main-building/components/hooks/use-rearrange-building-fields';
import {
  isSwappableBuildingField,
  villageViewBuildingFieldIds,
} from 'app/(game)/(village-slug)/(village)/(...building-field-id)/components/building-tabs/main-building/components/utils/building-field-rearrangement';
