...
import { factionTranslationMap, reputationLevelTranslationMap, resourceTranslationMap, tribeTranslationMap } from 'utils/translations';
import { getReportIconType, useReports } from 'hooks/game/use-reports';
