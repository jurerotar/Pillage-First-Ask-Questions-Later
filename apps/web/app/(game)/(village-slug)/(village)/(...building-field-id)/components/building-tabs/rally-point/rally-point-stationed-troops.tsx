...
import { RallyPointReinforcementsTab } from 'app/(game)/(village-slug)/(village)/(...building-field-id)/components/building-tabs/rally-point/components/stationed-troops/rally-point-reinforcements-tab';
import { RallyPointSentReinforcementsTab } from 'app/(game)/(village-slug)/(village)/(...building-field-id)/components/building-tabs/rally-point/components/stationed-troops/rally-point-sent-reinforcements-tab';
import { RallyPointStationedTroopsTab } from 'app/(game)/(village-slug)/(village)/(...building-field-id)/components/building-tabs/rally-point/components/stationed-troops/rally-point-stationed-troops-tab';
import {
  Section,
  SectionContent,
