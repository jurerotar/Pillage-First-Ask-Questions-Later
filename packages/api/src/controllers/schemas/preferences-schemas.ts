  ...
  .transform((t) => {
    return {
      ...
      isAutomaticNavigationAfterUnitResearchEnabled: Boolean(
        t.is_automatic_navigation_after_unit_research_enabled,
      ),
      isAutomaticNavigationAfterUnitUpgradeEnabled: Boolean(
        t.is_automatic_navigation_after_unit_upgrade_enabled,
      ),
      isAutomaticNavigationAfterSendUnitsEnabled: Boolean(
        t.is_automatic_navigation_after_send_units_enabled,
      ),
