        ...
        <div className="container relative mx-auto flex min-h-[300px] flex-col gap-2 lg:flex-row">
          <section className="flex flex-1 flex-col gap-6 p-2">
            ...
            <Text as="p">
              ...
              <b>train troops</b>, and wage war in <b>persistent</b>,{' '}
              <b>massive</b>, <b>offline-first</b> game worlds.
            </Text>
            ...
            <div className="flex-col gap-4 hidden lg:flex">
              <div className="flex flex-col gap-2">
                ...
                <Text as="p">
                  ...
                  <br />
                  <br />
                  <b>Pillage First!</b> is my attempt to recreate that
                  experience as a <b>single-player Travian alternative</b>, with
                  the same core mechanics, but <b>modernized</b>,{' '}
                  <b>offline-friendly</b>, and <b>fully open source</b>, with no
                  game mechanics to incentivize spending real-world money. Just
                  the <b>classic gameplay loop</b>, reimagined for{' '}
                  <b>solo play</b>.
                </Text>
              </div>
              <div className="flex flex-col gap-2">
