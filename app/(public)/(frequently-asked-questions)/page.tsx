        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-2">
            ...
            <Text>
              ...
              speed game worlds require more device resources, and maxing these
              out could cause lag, excessive battery drain and other issues.
              <br />
              <br />A 10x speed appears stable even on lower-end devices, which
              is why this speed was determined to be the higher limit for now.
            </Text>
          </div>
        </div>
      </main>
