...
export const buildings: Building[] = [
  ...
  //     },
  //   ],
  //   baseBuildingCost: [230, 190, 80, 60],
  //   buildingCostCoefficient: 1.28,
  //   maxLevel: 20,
  //   buildingDurationBase: 1.16,
  //   buildingDurationModifier: 4275,
  //   buildingDurationReduction: 2075,
  // },
  {
    id: 'HUNTERS_LODGE',
    category: 'infrastructure',
    ...
    baseBuildingCost: [390, 280, 250, 140],
    buildingCostCoefficient: 1.8,
    maxLevel: 5,
    buildingDurationBase: 1.16,
    buildingDurationModifier: 3675,
    buildingDurationReduction: 1775,
  },
  {
    id: 'GREAT_GRANARY',
    category: 'infrastructure',
