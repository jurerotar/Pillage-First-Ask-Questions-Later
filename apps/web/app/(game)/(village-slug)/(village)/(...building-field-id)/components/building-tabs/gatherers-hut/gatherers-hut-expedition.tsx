...
import { useGatherersHutExpeditions } from 'app/(game)/(village-slug)/(village)/(...building-field-id)/components/building-tabs/gatherers-hut/hooks/use-gatherers-hut-expeditions';
