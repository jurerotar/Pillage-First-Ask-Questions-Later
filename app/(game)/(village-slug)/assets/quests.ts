...
export const villageQuests: Omit<VillageQuest, 'villageId'>[] = [
  ...
  // Wheat
  createBuildingQuest('CROPLAND', 1),
  createBuildingQuest('CROPLAND', 2),
  createBuildingQuest('CROPLAND', 4),
  createBuildingQuest('CROPLAND', 6),
  createBuildingQuest('CROPLAND', 8),
  createBuildingQuest('CROPLAND', 10),
  createBuildingQuest('CROPLAND', 1, 'every'),
  createBuildingQuest('CROPLAND', 3, 'every'),
  createBuildingQuest('CROPLAND', 5, 'every'),
  createBuildingQuest('CROPLAND', 7, 'every'),
  createBuildingQuest('CROPLAND', 9, 'every'),
  // Main building
