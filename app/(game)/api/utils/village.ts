...
export const calculateVillageResourcesAt = (queryClient: QueryClient, villageId: Village['id'], timestamp: number) => {
...
export const addVillageResourcesAt = (queryClient: QueryClient, villageId: Village['id'], timestamp: number, resourcesToAdd: number[]) => {
