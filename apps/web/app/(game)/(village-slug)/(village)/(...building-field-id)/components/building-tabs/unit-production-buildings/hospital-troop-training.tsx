...
import { useWoundedTroops } from 'app/(game)/(village-slug)/(village)/(...building-field-id)/components/building-tabs/unit-production-buildings/hooks/use-wounded-troops';
