...
import { useDemolishBuildingErrorBag } from 'app/(game)/(village-slug)/(village)/(...building-field-id)/components/building-tabs/main-building/components/hooks/use-demolish-building-error-bag';
