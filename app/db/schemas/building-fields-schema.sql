...
(
  ...
  -- Uniqueness: a field can host at most one building per village
  ...
  CHECK (
    ...
    (field_id BETWEEN 19 AND 38 AND
     building_id NOT IN ('RALLY_POINT', 'CITY_WALL', 'EARTH_WALL', 'MAKESHIFT_WALL', 'PALISADE', 'STONE_WALL', 'WOODCUTTER', 'CLAY_PIT', 'IRON_MINE', 'WHEAT_FIELD'))
    )
);
