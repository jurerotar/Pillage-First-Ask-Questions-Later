    ...
    sql: `
      INSERT INTO
        preferences (player_id, is_accessibility_mode_enabled, is_reduced_motion_mode_enabled,
                     ...
                     is_automatic_navigation_after_building_level_change_enabled, is_developer_tools_console_enabled,
      ...
      VALUES
        ($player_id, 0, 0, 1, 'detailed', 1, ${Number(isRunningLocally)}, 1, 0, 0, 0)
    `,
    bind: {
      $player_id: PLAYER_ID,
    },
